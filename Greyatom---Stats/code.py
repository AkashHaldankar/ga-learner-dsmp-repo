...
for i in range(len(sample_size)):
    ...
    if i == 0:
        mean_series.plot.hist(ax=ax_1)
    elif i == 1:
        mean_series.plot.hist(ax=ax_2)
    else:
        mean_series.plot.hist(ax=ax_3)
...
#Code starts here
x_1 = data[data['paid.back.loan']=='No']['installment']
x_2 = data[data['paid.back.loan']=='Yes']['installment']

z_statistic, p_value = ztest(x1 = x_1, x2 = x_2)
print("Z-statistics = ",z_statistic)
print("p-value = ",p_value)
